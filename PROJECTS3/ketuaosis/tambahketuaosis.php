  ...
  if (tambahketuaosis ($_POST) > 0 ) {
    ...
    echo "
      <script>
        ...
        document.location.href = 'tambahketuaosis.php';
      </script>
    ";
  }		
}
...
<form action="" method="POST" enctype="multipart/form-data">
	<div class=" card bg-secondary rounded mt-3 mb-3">
		<div class="card-header py-3 bg-light">
			<h5 class="m-0 text-white">Tambah Ketua Osis</h5>
		</div>
		...
		<div class="card-body bg-secondary">
			<div class="form mt-3 row">
				...
				<div class="form-group col-sm-6">
					...
					<input required type="text" class="mt-1 mb-3 form-control" name="id_ketua" placeholder="Masukkan id ketua"  >
                </div>
				...
				<div class="dasd mt-2 mb-2">
					<br>
					<button type="submit" name="submit" class="btn dasd btn-success">Tambah Ketua Osis</button>
				</div>
			</form>
		</div>
	</div>
