...
?>
                        ...
                        <div class="bg-secondary rounded h-100 p-3">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-success text-white fw-bold" href="editketuaosis.php?id_ketua=<?= $getdata["id_ketua"]; ?>">Edit</a>

                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapus<?=$getdata["id_ketua"];?>" >Hapus</button>
    ...
    <div class="modal fade" id="hapus<?= $getdataa["id_ketua"]; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content bg-secondary">
                ...
                <div class="modal-footer">
                    ...
                    <a href="hapusketuaosis.php?id_ketua=<?= $getdataa["id_ketua"]; ?>" class="btn btn-primary">Hapus</a>
                </div>
            </div>
        </div>
    </div>
